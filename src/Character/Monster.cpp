...
void Monster::AnimLoadInit()
{
	...
	// アニメーションの読み込み
	m_animation.LoadAnimation("Data/Model/Monster/Animation/idle.mv1", idle_anim, 0, m_anim_info[idle_anim].play_speed,m_anim_info[idle_anim].blend_value);             //!< アイドル
	m_animation.LoadAnimation("Data/Model/Monster/Animation/Run.mv1", run_anim, 0, m_anim_info[run_anim].play_speed, m_anim_info[run_anim].blend_value);               //!< ラン
	m_animation.LoadAnimation("Data/Model/Monster/Animation/die.mv1", die_anim, 0, m_anim_info[die_anim].play_speed, m_anim_info[die_anim].blend_value);               //!< 死亡
	m_animation.LoadAnimation("Data/Model/Monster/Animation/shout.mv1", shout_anim, 0, m_anim_info[shout_anim].play_speed, m_anim_info[shout_anim].blend_value);           //!< 叫び
	m_animation.LoadAnimation("Data/Model/Monster/Animation/hit_damage.mv1", hit_damage_anim, 0, m_anim_info[hit_damage_anim].play_speed, m_anim_info[hit_damage_anim].blend_value); //!< ダメージを受けた時
	m_animation.LoadAnimation("Data/Model/Monster/Animation/stun_down.mv1", stun_down_anim, 0, m_anim_info[stun_down_anim].play_speed, m_anim_info[stun_down_anim].blend_value);   //!< スタンを食らった時のダウン
	m_animation.LoadAnimation("Data/Model/Monster/Animation/stun_up.mv1", stun_up_anim, 0, m_anim_info[stun_up_anim].play_speed, m_anim_info[stun_up_anim].blend_value);       //!< スタンを食らった時の起き上がり

	// 攻撃アニメーション
	m_animation.LoadAnimation("Data/Model/Monster/Animation/Attack/Punch.mv1", punch_attack_anim, 0, m_anim_info[punch_attack_anim].play_speed, m_anim_info[punch_attack_anim].blend_value);      //!< パンチ攻撃
	m_animation.LoadAnimation("Data/Model/Monster/Animation/Attack/Kick.mv1", kick_attack_anim, 0, m_anim_info[kick_attack_anim].play_speed, m_anim_info[kick_attack_anim].blend_value);            //!< キック攻撃
	m_animation.LoadAnimation("Data/Model/Monster/Animation/Attack/BigPunch.mv1", bigpunch_attack_anim, 0, m_anim_info[bigpunch_attack_anim].play_speed, m_anim_info[bigpunch_attack_anim].blend_value);   //!< 大パンチ攻撃
	m_animation.LoadAnimation("Data/Model/Monster/Animation/Attack/Breath.mv1", breath_attack_anim, 0, m_anim_info[breath_attack_anim].play_speed, m_anim_info[breath_attack_anim].blend_value);     //!< ブレス攻撃
	m_animation.LoadAnimation("Data/Model/Monster/Animation/Attack/tackle.mv1", tackle_attack_anim, 0, m_anim_info[tackle_attack_anim].play_speed, m_anim_info[tackle_attack_anim].blend_value);      //!< タックル攻撃
	m_animation.LoadAnimation("Data/Model/Monster/Animation/Attack/UpperPunch.mv1", upperpunch_attack_anim, 0, m_anim_info[upperpunch_attack_anim].play_speed, m_anim_info[upperpunch_attack_anim].blend_value); //!< アッパー攻撃
	m_animation.LoadAnimation("Data/Model/Monster/Animation/Attack/Rolling.mv1", rolling_anim, 0, m_anim_info[rolling_anim].play_speed, m_anim_info[rolling_anim].blend_value);           //!< ローリング
	m_animation.LoadAnimation("Data/Model/Monster/Animation/Attack/JumpAttack.mv1", jump_anim, 0, m_anim_info[jump_anim].play_speed, m_anim_info[jump_anim].blend_value);           //!< ジャンプ
