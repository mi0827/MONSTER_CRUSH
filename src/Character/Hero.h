...
public:
	...
	AnimInfo m_anim_info[anim_max] =
	{
		...
		{1.0f, 0.2f}, //! 走りアニメーション
		{1.7f, 0.15f}, //! ローリングアニメーション
		{1.0f, 0.2f}, //! ダメージアニメーション
		{1.0f, 0.2f}, //! 死んだときのアニメーション
		{2.5f, 0.2f}, //! 剣攻撃１アニメーション
		{2.5f, 0.2f}, //! 剣攻撃２アニメーション
		{2.5f, 0.1f}, //! 剣攻撃３アニメーション
		{2.3f, 0.2f}, //! 剣攻撃４アニメーション
		{2.3f, 0.2f}, //! キック攻撃１アニメーション
		{2.3f, 0.1f}, //! キック攻撃２アニメーション
		{3.5f, 0.2f}, //! カウンター攻撃アニメーション
	};
