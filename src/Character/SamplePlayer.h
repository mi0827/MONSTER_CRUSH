...
public:
	...
	AnimInfo m_anim_info[anim_max] =
	{
		...
		{1.0f, 0.2f}, //! 走りアニメーション
		{2.0f, 0.2f}, //! ローリングアニメーション
		{1.0f, 0.2f}, //! ダメージアニメーション
		{1.0f, 0.2f}, //! 死んだときのアニメーション
		{1.0f, 0.2f}, //! 攻撃１アニメーション
		{2.0f, 0.2f}, //! 攻撃２アニメーション
		{2.0f, 0.2f}, //! 攻撃３アニメーション
		{1.5f, 0.2f}, //! キック攻撃１アニメーション
		{1.5f, 0.2f}, //! キック攻撃２アニメーション
		{1.5f, 0.2f}, //! キック攻撃３アニメーション
		{1.5f, 0.2f}, //! カウンター攻撃アニメーション
	};
