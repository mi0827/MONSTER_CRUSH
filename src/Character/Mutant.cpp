...
void Mutant::Anima_Load_Init()
{
	...
	m_animation.Load_Animation("Data/Model/Mutant/Animation/Punch2.mv1", attack_2, 0, 1.0f); //!< 攻撃２
	m_animation.Load_Animation("Data/Model/Mutant/Animation/Punch3.mv1", attack_3, 0, 1.0f); //!< 攻撃３
	m_animation.Load_Animation("Data/Model/Mutant/Animation/Punch4.mv1", attack_4, 0, 1.0f); //!< 攻撃４
	m_animation.Load_Animation("Data/Model/Mutant/Animation/Rolling.mv1", rolling, 0, 1.0f); //!< ローリング
	m_animation.Load_Animation("Data/Model/Mutant/Animation/jump.mv1", jump, 0, 1.0f); //!< ジャンプ
