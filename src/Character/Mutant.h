...
public:
	...
	{
		{1.0f, 0.1f}, //! アイドルアニメーション
		{1.0f, 0.2f}, //! ランアニメーション
		{1.0f, 0.2f}, //! 死んだときのアニメーショーン
		{0.5f, 0.15f}, //! 叫びアニメーション
		{1.0f, 0.2f}, //! ダメージアニメーション
		{1.5f, 0.2f}, //! スタンダウンアニメーション
		{2.0f, 0.2f}, //! スタン起き上がりアニメーション
		{1.5f, 0.2f}, //! パンチ攻撃アニメーション
		{1.0f, 0.2f}, //! ソード攻撃１アニメーション
		{1.3f, 0.1f}, //! ソード攻撃２アニメーション
		{1.5f, 0.1f}, //! ソード攻撃３アニメーション
		{1.0f, 0.2f}, //! ソード攻撃４アニメーション
		{1.5f, 0.2f}, //! ソード攻撃５アニメーション
		{1.5f, 0.1f}, //! ローリングアニメーション
		{1.0f, 0.2f}, //! ジャンプアニメーション
	};
...
private:
	...
	{
		// パンチ攻撃１
		{ {4.0f,4.0f,4.0f}, -1, {15.0f,14.0f,15.0f},{90.0f,180.0f,0.0f}, 5},
		// ソード攻撃１
		{ {6.0f,6.0f,6.0f}, -1, {20.0f,18.0f,20.0f},{35.0f,-90.0f,0.0f}, 60},
		// ソード攻撃２
		{ {6.0f,6.0f,6.0f}, -1, {20.0f,25.0f,20.0f},{155.0f,-90.0f,0.0f}, 40},
		// ソード攻撃３
		{ {6.0f,6.0f,6.0f}, -1, {15.0f,20.0f,15.0f},{35.0f,-90.0f,0.0f}, 30},
		// ソード攻撃４
		{ {5.0f,5.0f,5.0f}, -1, {15.0f,24.0f,15.0f},{85.0f,-90.0f,0.0f}, 1},
		// ソード攻撃５
		{ {6.0f,6.0f,6.0f}, -1, {15.0f,20.0f,15.0f},{90.0f,-90.0f,10.0f}, 30},
		// ダメージを受けた時のエフェクト
